...
class Sphere(NodeItem):
    ...
    def __init__(self, pos: tuple, undo_stack: QtWidgets.QUndoStack, name: str = REG_NAME,
        ...
        self._socket_widgets: list[SocketWidget] = [
            ValueLineAk(undo_stack=self._undo_stack, name="R", content_value=10., is_input=True, parent_node=self),
    ...
    @staticmethod
    def make_sphere(radius: float) -> Part.Shape:
    ...
    def eval_0(self, *args) -> list:
        ...
        with warnings.catch_warnings():
            ...
            try:
                try:
                    radius: list = self.input_data(0, args)
                    result: list = list(map_objects(radius, float, self.make_sphere))
